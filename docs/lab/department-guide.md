...
sidebar_label: Department Guide
sidebar_position: 1
description: The unified structural framework for all departments within The Human Pattern Lab.
---
...
## 2. How Departments Fit Into the Lab Model
...
- **Lyric** — Director of Synthesis, Continuity & Multiversal Stability
...
## 3. Universal Department Structure
...
## 6. Department Badges & Iconography
...
- tools
- cross-links
- supplemental chaos footnotes (optional but likely)

This guide defines the meta-structure so all pages feel unified.
...
Departments evolve.  
Mascots evolve.  
Occasionally, an anomaly becomes a department.

Changes to this guide are logged in:

```
dept-guide-changelog.md
```

Orbson reviews amendments.  
Lyric enforces continuity.  
Carmel judges in silence.
